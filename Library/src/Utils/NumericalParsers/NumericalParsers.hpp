...
namespace Library
{
    namespace Utils
    {
        ...
        [[nodiscard]] inline bool ParseInt(const std::string &string, int &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseLong(const std::string &string, long &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseUnsignedLong(const std::string &string, unsigned long &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseLongLong(const std::string &string, long long &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseUnsignedLongLong(const std::string &string, unsigned long long &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseShort(const std::string &string, short &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseUnsignedShort(const std::string &string, unsigned short &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseFloat(const std::string &string, float &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseDouble(const std::string &string, double &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseLongDouble(const std::string &string, long double &value) noexcept;
        ...
        /// \return `true` if the parsing is successful, `false` otherwise
        [[nodiscard]] inline bool ParseBool(const std::string &string, bool &value) noexcept;
    } // namespace Utils
} // namespace Library
